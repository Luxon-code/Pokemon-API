            ...
            .then(data => {
                ...
                if(textoBuscar.length >=2){
                    ...
                    filtroPokemon.forEach(element => {
                        ...
                        lista += `<a onclick="detallePokemon2('${element.url}')" href="detallePokemon.html" class="list-group-item list-group-item-action">${element.name} <img id="icono${element.name}" style="width: 20%"></a>`
                    });
                    lista += `</div>`
